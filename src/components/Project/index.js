    ...
    <div className="project-list justify-space-around" style={{display: 'flex', "flexWrap": "wrap"}}>
        <div className="text-format" style={{width: '45%'}}>
            ...
            <div className="img-project-container">
                <img className="img-project" style={{"borderRadius": '2%'}}src={projects[0].img} alt='deep-thoughts-project'></img>
            </div>
        </div>
        <div className="text-format" style={{width: '45%'}}>
            ...
            <div className="img-project-container">
                <img className="img-project" style={{"borderRadius": '2%'}}src={projects[1].img} alt='obscure-tv-project'></img>
            </div>
        </div>
        <div className="text-format" style={{width: '45%'}}>
            ...
            <div className="img-project-container">
                <img className="img-project" style={{"borderRadius": '2%'}}src={projects[2].img} alt='job-hunter-project' onMouseEnter={displayLink}></img>
            </div>
        </div>
        <div className="text-format" style={{width: '45%'}}>
            ...
            <div className="img-project-container">
                <img className="img-project" style={{"borderRadius": '2%'}}src={projects[3].img} alt='tech-blog-project'></img>
            </div>
        </div>
        <div className="text-format" style={{width: '45%'}}>
            ...
            <div className="img-project-container">
                <img className="img-project" style={{"borderRadius": '2%'}}src={projects[4].img} alt='budget-tracker-project'></img>
            </div>
        </div>
        <div className="text-format" style={{width: '45%'}}>
            ...
            <div className="img-project-container">
                <img className="img-project" style={{"borderRadius": '2%'}} src={projects[5].img} alt='note-taker-project'></img>
            </div>
        </div> 
    </div>
   );
